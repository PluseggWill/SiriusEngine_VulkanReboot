...
| **Default scene** | `Data/Scenes/sponza.json` (fetch required; CI smoke uses [`stress.json`](../Data/Scenes/stress.json); Stage 1 golden still uses [`demo.json`](../Data/Scenes/demo.json)) |
