...
## 2026-05-26 — M1 visual sign-off

- **Plan ref:** M1 acceptance (transparent over opaque)
- **Files:** (none — sign-off only)
- **What changed:** User confirmed transparent monkey renders correctly; opaque geometry behind it remains visible (order + blend).
- **Verification:** Manual visual check on demo scene (Kenney camp + overlay monkey, material 2, alpha 0.35).
