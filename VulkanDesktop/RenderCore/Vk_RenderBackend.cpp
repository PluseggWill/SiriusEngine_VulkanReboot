...
bool Vk_RenderBackend::ValidateFramePacketParity( const Gfx_FrameRenderPacket& aPacket, size_t aOpaqueDrawCount, size_t aTransparentDrawCount,
                                                  size_t aOpaqueBatchCount, size_t aTransparentBatchCount ) {
