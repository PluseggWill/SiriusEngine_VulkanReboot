...
VkDescriptorSetLayoutBinding VkInit::DescriptorSetLayoutBinding(VkDescriptorType aType, VkShaderStageFlags someStageFlags, uint32_t aBinding) {
    VkDescriptorSetLayoutBinding layoutBinding{};

    layoutBinding.binding            = aBinding;
    layoutBinding.descriptorType     = aType;
    layoutBinding.descriptorCount    = 1;
    layoutBinding.stageFlags         = someStageFlags;
    layoutBinding.pImmutableSamplers = nullptr;

    return layoutBinding;
}

VkWriteDescriptorSet VkInit::WriteDescriptorBuffer(VkDescriptorType aType, VkDescriptorSet aDstSet, VkDescriptorBufferInfo* aBufferInfo, uint32_t aBinding) {
...
VkWriteDescriptorSet VkInit::WriteDescriptorImage(VkDescriptorType aType, VkDescriptorSet aDstSet, VkDescriptorImageInfo* anImageInfo, uint32_t aBinding) {
    VkWriteDescriptorSet descriptorWrite{};
    ...
    descriptorWrite.pImageInfo       = anImageInfo;
    descriptorWrite.pTexelBufferView = nullptr;
