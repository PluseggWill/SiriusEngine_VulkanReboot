...
public:
    ...
    // Scene default: viewport + scissor + line width (see Vk_Renderer::SetGraphicsDynamicState).
    void SetDefaultDynamicStates();

    // aPipelineCache: Vk_Renderer::myPipelineCache (VK_NULL_HANDLE allowed but disables cross-run reuse).
